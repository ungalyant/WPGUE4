...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FAILastStepSignature);
...
public:
	...
	UPROPERTY(BlueprintAssignable, meta = (DisplayName = "LastStep"))
	FAILastStepSignature RecieveLastStep;
	...
	/** Returns position of current path segment's end. */
	UFUNCTION(BlueprintCallable, Category = "AI|Navigation")
	FVector GetNextMoveDestination() const;
