...
void AAIController::OnLastStep()
{
	RecieveLastStep.Broadcast();
}
...
FVector AAIController::GetNextMoveDestination() const
{
	return (PathFollowingComponent) ? PathFollowingComponent->GetNextTargetLocation() : FVector::ZeroVector;
}
